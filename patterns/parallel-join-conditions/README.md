# Pattern: parallel-join-conditions

Reference: every join condition (all / any / at_least:K / percent:P / expression / aggregator). Use for: any fan-out where you need to choose join semantics.
