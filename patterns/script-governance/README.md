# Pattern: script-governance

Hash-pinned script execution behind review gate. Use for: dangerous operations (deploy / migrate / destructive) requiring acknowledgment.
