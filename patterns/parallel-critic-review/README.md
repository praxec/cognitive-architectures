# Pattern: parallel-critic-review

Fan out N critics (security/perf/style/correctness) in parallel; aggregator synthesizes the verdict. SPEC §24 parallel + aggregator. Use for: PR review, plan review, spec review.
...
version: "1.0.0"
include:
  - ../patterns/parallel-critic-review/pattern.yaml
