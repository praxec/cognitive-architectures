...
Agent edits HARD-rejected when outside declared file glob. SPEC §28 path_allowlist enforcement at the transition boundary. Use for: any agent code-edit workflow.
...
version: "1.0.0"
include:
  - ../patterns/scope-bounded-edit/pattern.yaml
