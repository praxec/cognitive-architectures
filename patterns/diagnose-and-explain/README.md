# Pattern: diagnose-and-explain

Parallel hypothesis exploration → evidence aggregation → synthesis. Use for: bug diagnosis, root-cause analysis, design-investigation tasks.
...
version: "1.0.0"
include:
  - ../patterns/diagnose-and-explain/pattern.yaml
